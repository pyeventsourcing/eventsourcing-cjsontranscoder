...
# Welcome to Eventsourcing CJSONTranscoder
...
After cloning the eventsourcing-cjsontranscoder repository, set up a virtual
...
Add tests in `./tests`. Add code in `./eventsourcing_cjsontranscoder`.
